...
function Login({ session }) {
  ...
  return (
    <>
      <div className="min-h-screen h-full flex bg-background text-white">
          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              <img
                ...
                alt="Workflow"
              />
              <h2 className="mt-6 text-3xl font-extrabold text-main">Sign in to your account</h2>
            ...
            <div className="mt-8">
              <div>
                <div>
                  <p className="text-sm font-medium text-main text-center">Sign in with</p>
                  <p className="mb-4 text-center text-xs text-main">{loginState}</p>
