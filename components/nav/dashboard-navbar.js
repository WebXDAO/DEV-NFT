    ...
    window.ethereum
      ? window.ethereum
        ...
        .then((accounts) => {
          ...
          setHeroButton('Dashboard') // @mkubdev this is giving error everywhere 😕
        })
  ...
  useEffect(async () => {
    ...
    web3.eth.getAccounts().then(async (addr) => {
      ...
      if (addr.length > 0) {
        ...
        setHeroButton('Marketplace') // @mkubdev this is giving error everywhere 😕
      }
    })
  }, [])
    ...
    <>
                          ...
                          {session && (
                            <>
                              <img
                                ...
                                alt=""
                              />
                              <div className="text-base font-medium text-white mx-4">
                                {session.name}
                              </div>
                            </>
                          )}
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between">
          <h1 className="flex items-center justify-center text-lg leading-6 font-semibold text-gray-900">
            {headerName}
          </h1>
          {address.length > 0 && (
            <>
