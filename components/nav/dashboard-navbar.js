...
function Navbar({ router, headerName }) {
  ...
  return (
    <>
      <Disclosure as="nav" className="bg-brand">
        {({ open }) => (
          <>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                          ...
                          <a
                            className={classNames(
                              router.asPath == item.href
                                ? 'bg-primary border border-main text-white'
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <Menu as="div" className="ml-3 relative">
                      <div>
                        <div className="max-w-xs bg-primary rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white">
                          ...
                          {!session && <>
                            <a
                              onClick={() => signIn()}
                              href="#"
                              className="flex items-center justify-center px-4 py-2 text-xs rounded-md text-white bg-primary md:py-2 md:text-sm md:px-10"
                            >
                              Login to Github
                            </a>
                          </>}
                    ...
                    {session && <>
                      <button
                        type="button"
                        className="p-1 bg-primary rounded-full text-main hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white"
                      >
                ...
                <div className="-mr-2 flex md:hidden">
                  {/* Mobile menu button */}
                  <Disclosure.Button className="bg-primary inline-flex items-center justify-center p-2 rounded-md text-main hover:text-white hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white">
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="flex pt-4 pb-3 border-t border-primary justify-between">
                {session && <>
                  <div className="flex">
