    ...
    <>
      ...
      <div className="relative bg-background py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
          <p className="mt-2 text-3xl font-extrabold text-main tracking-tight sm:text-4xl">
                ...
                <div key={feature.name} className="pt-6">
                  <div className="flow-root rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      ...
                      <h3 className="mt-8 text-lg font-medium text-main tracking-tight">{feature.name}</h3>
